...
Specifically, a word is represented as a list of segments (this is the meaning of
\texttt{Vec<Segment>}). At this point, you might ask: why not represent words simply
as a list of characters? What's the difference between a character and a segment?
This reflects a complication in computers' handling of text beyond simple English
characters, covered by the ASCII character encoding. Unicode, an improvement of
ASCII that handles many more languages beyond those which use the Latin alphabet,
would consider the accent mark and letter \textipa{O} in \textipa{\'O}, to be
separate characters, and not part of the same. We must sidestep this issue by
...
onsets minus the number of nuclei. This will never be a negative number,
...
For instance, changing \textipa{/ow\'o-k\'i-ow\'o/} into
...
to illustrate with an example. Given \textipa{/ow\'o-k\'i-ow\'o/} as
